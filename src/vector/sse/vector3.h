...
namespace overdrive::math
{
    ...
    {
        using boolvector = vector<bool, 3, isa::sse>;
        template<int N, int x, int y, int z = 0>
        using swizzle = swizzle<float, N, isa::sse, x, y, z>;
        ...
        vector cross(const vector& v) const noexcept;
